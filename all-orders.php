            ...
            <li class="multi-level">
                <a href="#" class="item">
                    <div class="icon-box bg-success">
                        <ion-icon name="checkbox-outline" role="img" class="md hydrated" aria-label="radio outline"></ion-icon>
                    </div>
                    <div class="in">
                    

                        <div>
                        <header>Order Date: <?php echo $list['date_time'] ; ?> </header>    
                        #Order No.  <?php echo $list['id'] ;?>
                        <footer>
                        ...
                        <span class="badge badge-primary">Click to View</span>
                    </div>
                </a>
                <!-- sub menu -->
                <ul class="listview simple-listview" style="height: 0px;">
                <?php 
                    
                    $data = explode(',',$list['order_details']);
                    foreach($data as $out) {
                       ?>
                    <li>
                    <span class="badge badge-success text-dark"><?php echo $out;?></span>
