            ...
            <li class="multi-level">
                <a href="#" class="item">
                    <div class="icon-box bg-primary">
                        <ion-icon name="radio-outline" role="img" class="md hydrated" aria-label="radio outline"></ion-icon>
                    </div>
                    <div class="in">
                        <div><?php echo $list['shopname'] ;?></div>
                        <div class="chip">
                        <span class="chip-label">
                        <?php

$rtid= $list['id'];
$oc = "SELECT * FROM orders WHERE retailer_id=$rtid ";
$ooc = mysqli_query($db, $oc);
$ordercount = mysqli_num_rows($ooc);
...
?> Orders
                ...
                <ul class="listview simple-listview" style="height: 0px;">
                    <li>Name: <?php echo $list['name'] ;?></li>
                    <li>Phone Number: <?php echo $list['phone'] ;?></li>
