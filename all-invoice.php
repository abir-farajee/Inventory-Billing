        ...
        while($list = mysqli_fetch_assoc($order)) {
            ...
            <li >
                <div class="item">
                    ...
                    <a href="print.php?orderid=<?php echo $list['id'] ; ?>" class="btn btn-secondary me-1 mb-1"><ion-icon name="print-outline" role="img" class="md hydrated" aria-label="document text outline"></ion-icon>
                    Print</a>
                    </div>
